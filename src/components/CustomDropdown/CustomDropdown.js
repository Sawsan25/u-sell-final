...
import {redirect } from '../../helpers/utilities'
...
export default function CustomDropdown(props) {
  ...
  return (
    <div onMouseEnter={handleClick} onMouseLeave={() => handleClose(dropdownHeader)}>
      <div>
        <Button
        ...
        >
          ...
          {!props?.withAvatar && caret ? <b className={caretClasses} /> : null}
        </Button>
      </div>
      <Popper
                      ...
                      return (
                        <MenuItem
                          ...
                          onClick={() => {
                            ...
                            redirect(prop.history ,prop.pathName )
                            handleClose(prop)
                          }}
                        ...
                        >
                          <span className={classes.spanholder}>
                            <FaAngleRight style={{ marginBottom: 5, marginRight: 10, alignItems: 'center', marginTop: 5 }} color="#475F7B" />
                            {prop?.title}
